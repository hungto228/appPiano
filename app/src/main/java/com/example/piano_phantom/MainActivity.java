...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    //recording of the radio of piano key
    ...
    private Button mLeftNavigation, mRightNaviogation, mRecord, mPlaying;
...
//        private int c7, c7black, d7, d7black, e7, f7, f7black, g7, g7black, a7, a7black, b7;
        ...
        mRightNaviogation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                scrollView.scrollTo((int) scrollView.getScrollX() + 30, (int) scrollView.getScrollY());
            }
...
//        private int c7, c7black, d7, d7black, e7, f7, f7black, g7, g7black, a7, a7black, b7;
    ...
    private void initButon() {
        mLeftNavigation = findViewById(R.id.bt_left_navigation);
        mRightNaviogation = findViewById(R.id.bt_right_navigation);
        mRecord = findViewById(R.id.bt_record);
        mPlaying = findViewById(R.id.bt_play_recording);
...
//    private int c7, c7black, d7, d7black, e7, f7, f7black, g7, g7black, a7, a7black, b7;
    ...
    public void record(View view) {
        ...
        if(mStartRecording){
            mRecord.setText("hoan thanh");

        }else {
            mRecord.setText("dang quay");
        }
    ...
    private void onRecord(boolean start) {
        if (start) {
            ...
            stopRecording();
            if (recordingno == 1) {
                Toast recondingmsg = Toast.makeText(this, "song" + 6 + "saved", Toast.LENGTH_SHORT);
                recondingmsg.show();
            } else {
    ...
    private void startRecording() {
        ...
        editor.putInt("finleno", recordingno);
        editor.commit();
